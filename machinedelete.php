...
<body id="page-top">
    ...
    <h1 class="text-center" >Data to perform machine CRUD Operations</h1>
      <a href="machinecreate.php" class='btn btn-outline-dark mb-2'> <i class="bi bi-person-plus"></i> delete New machine</a>
 ...
 // for displaying an error msg in case the connection is not established
  if (!$conn) {                                             
    die("Connection failed: " . mysqli_connect_error());     
     ...
     if(isset($_GET['machinedelete']))
     {
         $user_id= $_GET['machinedelete'];

         // SQL query to delete data from user table where id = $userid
         $query = "DELETE FROM airplane_details WHERE numser = {$user_id}"; 
         $delete_query= mysqli_query($conn, $query);
         header("Location: machinehome.php");
     }
              ?>
