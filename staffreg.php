        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="flighthome.php">
                    ...
                    <span>Manage Flight operaions</span></a>
            </li>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create staff Account!</h1>
                            </div>
                            <form class="user" action="authenticatestaff.php" method="post">
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user"
                                            id="example" name="address" placeholder="Address">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user"
                                            id="exampleInput" name="username" placeholder="username">
                                    </div>
                                    <div class="col-sm-6">
                            ...
                            <hr>
                            <a href="staffupdate.php">staff update </a>
                        </div>
                    </div>
                </div>
            </div>
