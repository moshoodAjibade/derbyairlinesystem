        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- /.container-fluid -->
					...
					<div class="container">
    <h1 class="text-center" >Data to perform Flight Operations</h1>
      <a href="machinecreate.php" class='btn btn-outline-dark mb-2'> <i class="bi bi-person-plus"></i> delete Added Flight</a>
 ...
 // for displaying an error msg in case the connection is not established
  if (!$conn) {                                             
    die("Connection failed: " . mysqli_connect_error());     
     ...
     if(isset($_GET['flightdelete']))
     {
         $flightid= $_GET['machinedelete'];

         // SQL query to delete data from user table where id = $userid
         $query = "DELETE FROM flight_details WHERE flight_id = {$flightid}"; 
         $delete_query= mysqli_query($conn, $query);
         header("Location: flighthome.php");
     }
              ?>
