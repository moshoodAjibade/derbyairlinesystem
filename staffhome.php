            ...
            <div id="content">
                ...
                <!-- /.container-fluid -->
				   ...
				   <div class="container">
					...
					<div class="container">
    <h1 class="text-center" >Data to perform STAFF Operations</h1>
      <a href="machinecreate.php" class='btn btn-outline-dark mb-2'> <i class="bi bi-person-plus"></i> Create New Staff</a>

        <table class="table table-striped table-bordered table-hover">
          <thead class="table-dark">
            <tr>
              <th  scope="col">EmpNum</th>
              ...
              <th  scope="col" colspan="3" class="text-center">STAFF CRUD Operations</th>
            </tr>  
          </thead>
            <tbody>
              <tr>
  ...
  if (!$conn) {                                             
    die("Connection failed: " . mysqli_connect_error());     
            ...
            while($row= mysqli_fetch_assoc($view_users)){
              ...
              echo " <td class='text-center'> <a href='staffview.php?user_id={$EmpNum}' class='btn btn-primary'> <i class='bi bi-eye'></i> View</a> </td>";

              echo " <td class='text-center' > <a href='staffupdate.php?edit&user_id={$EmpNum}' class='btn btn-secondary'><i class='bi bi-pencil'></i> UPDATE</a> </td>";

              echo " <td  class='text-center'>  <a href='staffdelete.php?delete={$EmpNum}' class='btn btn-danger'> <i class='bi bi-trash'></i> DELETE</a> </td>";
              echo " </tr> ";
                  }  
                ?>
              </tr>  
