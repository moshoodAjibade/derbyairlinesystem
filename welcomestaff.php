...
<html>
	...
	<body>
		...
		<div>
			<ul>
				<li><a href="stafflogin.php"><i class="fa fa-home" aria-hidden="true"></i> Home</a></li>
				<li><a href="searchflight.php"><i class="fa fa-home" aria-hidden="true"></i> Book flights</a></li>
