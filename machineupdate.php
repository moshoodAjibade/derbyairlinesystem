 ...
 // for displaying an error msg in case the connection is not established
  if (!$conn) {                                             
				...
				if(isset($_GET['user_id']))
    {
      ...
      $query="SELECT * FROM airplane_details WHERE numser = $user_id ";
    ...
    if(isset($_POST['Submit'])) 
    {
      ...
      $query = "UPDATE users SET plane_type = '{$plane_type}' , total_capacity = '{$total_capacity}' , active = '{$active}' WHERE numser = $numser";
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">update machine Account!</h1>
                            </div>
                            <form class="user" action="" method="post">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" name="numser"
                                            placeholder="numser"  value="<?php echo $numser  ?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" name="plane_type"
                                            placeholder="plane_type" value="<?php echo $plane_type  ?>">
                                    </div>
                                </div>
								...
								<div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user"
                                            name="total_capacity" placeholder="total_capacity" value="<?php echo $total_capacity  ?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user"
                                            id="example" name="active" placeholder="Active" value="<?php echo $active  ?>">
                                    </div>
                                </div>
