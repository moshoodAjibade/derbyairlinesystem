                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create machine Account!</h1>
                            </div>
								...
								<div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user"
                                            name="total_capacity" placeholder="total_capacity">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user"
                                            id="example" name="active" placeholder="Active">
                                    </div>
                                </div>
 ...
 // for displaying an error msg in case the connection is not established
  if (!$conn) {                                             
    die("Connection failed: " . mysqli_connect_error());     
        ...
        // SQL query to insert user data into the machine table
        $query= "INSERT INTO airplane_details(numser, plane_type, total_capacity,active ) VALUES('{$numser}','{$plane_type}','{$total_capacity}','{$active}')";
        ...
        // displaying proper message for the user to see whether the query executed perfectly or not 
          ...
          else { echo "<script type='text/javascript'>alert('Airplane Machine added successfully!')</script>";
              }         
    }
?>
