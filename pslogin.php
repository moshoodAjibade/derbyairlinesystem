...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="psbook.php">Book for Flight</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                    ...
                    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Derby airline</span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="logout_handler.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
	...
	<br>
		<form class="float_form" style="padding-left: 40px" action="authenticatelogin.php" method="POST">
			<fieldset>
				...
				Customer <input type='radio' name='user_type' value='Customer' checked/> staff <input type='radio' name='user_type' value='Administrator'/>
				<br>
				<?php
			...
			<br>
			<a href="psreg.php"><i class="fa fa-user-plus" aria-hidden="true"></i> Create New User Account?</a>
		</form>
	</body>
