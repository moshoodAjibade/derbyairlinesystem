    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Derby Airplane </div>
            </a>
...
?>
	...
	<body>
		...
		<form action="cancelticket.php" method="post">
			<h2>MODIFY PERSONAL FLIGHTS</h2>
			
					<input type="text" placeholder="Enter the PNR" name="pnr" />
			...
			<br>
			<input type="submit" value="Modify/Cancel Ticket" name="Search">
		</form>
