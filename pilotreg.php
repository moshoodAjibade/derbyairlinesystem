                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create pilot Account!</h1>
                            </div>
                            <form class="user" action="authenticatepilot.php" method="post">
                            
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" name="pilotratings"
                                            placeholder="pilotratings">
                                    </div>
                                    <div class="col-sm-6">
