                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create Flight Details!</h1>
                            </div>
                            <form class="user" action="" method="post">
								...
								<div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user"
                                            name="to_city" placeholder="to_city">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user"
                                            id="example" name="departure_date" placeholder="departure_date">
                                    </div>
                                </div>
								 <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
								...
								<div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user"
                                            name="arrival_time" placeholder="arrival_time">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user"
                                            id="example" name="seats_economy" placeholder="seats_economy">
                                    </div>
                                </div>
								 <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" name="seats_business"
                                            placeholder="seats_business">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" name="price_economy"
                                            placeholder="price_economy">
                                    </div>
                                </div>
								...
								<div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user"
                                            name="price_business" placeholder="price_business">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user"
                                            id="example" name="numser" placeholder="numser">
                                    </div>
                                </div>
 ...
 // for displaying an error msg in case the connection is not established
  if (!$conn) {                                             
    die("Connection failed: " . mysqli_connect_error());     
        ...
        $query= "INSERT INTO flight_details(flight_no, from_city, to_city, departure_date, arrival_date, departure_time,  arrival_time, seats_economy, seats_business, price_economy, price_business, numser)
		VALUES('{$flight_no}','{$from_city}','{$to_city}','{$departure_date}','{$arrival_date}','{$departure_time}','{$arrival_time}','{$seats_economy}','{$seats_business}','{$price_economy}','{$price_business}','{$numser}')";
        $add_flight = mysqli_query($conn,$query);
        ...
        // displaying proper message for the user to see whether the query executed perfectly or not 
          ...
          else { echo "<script type='text/javascript'>alert('Flight Details added successfully!')</script>";
              }         
    }
?>
